...
# python3 validator.py "/home/sheldak/dev/PyCharm/GraphAlgorithms/lab2/flow/" "/home/sheldak/dev/PyCharm/GraphAlgorithms/lab2/"     flow
# python3 validator.py "/home/sheldak/dev/PyCharm/GraphAlgorithms/lab2/connectivity/" "/home/sheldak/dev/PyCharm/GraphAlgorithms/lab2/"   connectivity
...
for script in os.listdir(scripts):
    ...
    if os.path.isfile(curr_script) and curr_script.endswith(
            ".py") and script == "edge_connectivity.py":
        ...
        for filename in os.listdir(solutions):
            ...
            if first_line[0] == 'c':
                ...
                if response == expected:    # checking if algorithm makes right output
                    print("Accepted on: ", path, " in time: ", end_time - start_time)
