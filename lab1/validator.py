...
# python3 validator.py "/home/sheldak/dev/PyCharm/GraphAlgorithms/lab1/graphs_examples/" "/home/sheldak/dev/PyCharm/GraphAlgorithms/lab1/"
...
for script in os.listdir(scripts):
    ...
    if os.path.isfile(curr_script) and curr_script.endswith(
            ".py") and script != "dimacs.py" and script != "validator.py":
